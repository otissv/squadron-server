...
export const actionsMock = [
  ...
  {
    key: `${SERVICE}:actions:FISCAL_YEAR_FIND_ALL`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:FISCAL_YEAR_FIND_BY_ACTIVE`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:FISCAL_YEAR_FIND_BY_ID`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:FISCAL_YEAR_CREATE`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:FISCAL_YEAR_UPDATE`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:FISCAL_YEAR_REMOVE`,
    roles: ['admin', 'user']
  },
  ...
  {
    key: `${SERVICE}:actions:TEAM_FIND_ALL`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:TEAM_FIND_BY_ID`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:TEAM_UPDATE`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:TEAM_CREATE`,
    roles: ['admin', 'user']
  },
  {
    key: `${SERVICE}:actions:TEAM_REMOVE`,
    roles: ['admin', 'user']
  },
